...
int desliga_vermelho_callback(alarm_id_t id, void *user_data);
int desliga_azul_callback(alarm_id_t id, void *user_data);
int desliga_todos_callback(alarm_id_t id, void *user_data);
